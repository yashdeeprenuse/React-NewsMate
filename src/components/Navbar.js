...
export default class Navbar extends Component {
  ...
  render() {
   ...
   <nav className="navbar navbar-expand-lg  " style={{backgroundColor:"#f7d31b"}}>
  <img src='logo0.jpg' style={{width:"40px", height:"40px", marginLeft: "10px"}}></img>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active suiii" aria-current="page" to="/">Home</Link>
        </li>
